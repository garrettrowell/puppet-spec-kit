...
4. **Directory Structure**: Creates the proper `design-specs/[branch-name]/` structure for all related documents
...
# - Generates design-specs/003-chat-system/spec.md
...
# - design-specs/003-chat-system/plan.md
# - design-specs/003-chat-system/research.md (WebSocket library comparisons)
# - design-specs/003-chat-system/data-model.md (Message and User schemas)
# - design-specs/003-chat-system/contracts/ (WebSocket events, REST endpoints)
# - design-specs/003-chat-system/quickstart.md (Key validation scenarios)
# - design-specs/003-chat-system/tasks.md (Task list derived from the plan)
```
